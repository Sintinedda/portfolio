<script setup>
    ...
    const works = ref([
        ...
        },
        {
            ...
            pdf : "/espaceCommentaireDynamique.pdf",
            image: "work-3"
        },
        {
            nom: "tifosi",
...
<template>
    <div id="modal">
        <section v-for="(work, index) in works">
            <button @click="openModal"><img :src="`/assets/${work.image}.png`" :id="index" :alt="`${work.image}`"><br>
